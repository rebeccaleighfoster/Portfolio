...
function Resume(props) {
    return (
        ...
        <div className="rela-block top-bar">
            <div className="caps name"><div className="abs-center">Rebecca Foster</div></div>
        </div>
        ...
        <img
          ...
          ></img>
            ...
            <p className="rela-block list-thing">TDD with Mocha, Jasmine and Karma</p>
            ...
            <p className="rela-block list-thing">Warren Wilson College -Bachelors in Social Work</p>
            <p className="rela-block list-thing">Thinkful - Engineering Immersion</p>
        </div>
